...
def build_transform_gen(cfg, is_train):
    ...
    if not is_train:
        # Deterministic test-time resize to fixed size (no flip, no random scale).
        # pad=False: let ImageList handle padding so images.image_sizes reflects
        # the true content area, which sem_seg_postprocess needs to crop correctly.
        return [
            T.ResizeScale(min_scale=1.0, max_scale=1.0, target_height=image_size, target_width=image_size),
...
class COCOInstanceNewBaselineDatasetMapper:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            mask_format: "polygon" or "bitmask". Use "bitmask" for RLE annotations.
        """
    ...
    def __call__(self, dataset_dict):
        ...
        if "annotations" in dataset_dict:
            ...
            # Convert masks to dense tensor [N, H, W] — keep as uint8, NOT float.
