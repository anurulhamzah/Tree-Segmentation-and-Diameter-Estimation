#!/usr/bin/env python3
"""Figur pendamping Figure 4: scene plantation, sama persis empat panel dan protokolnya.

Dipakai berdampingan dengan gen_fig4_panels.py (scene rainforest) untuk memberi pembaca
gambaran visual atas temuan §4.2: AP50 79,86% di gambar plantation vs 48,14% di rainforest.
Scene dipilih dengan jumlah instance GT sama (10) dengan scene rainforest, supaya perbandingan
visual tidak bias oleh kepadatan scene yang berbeda.
...
Jalankan:  python scripts/gen_fig4c_panels_plantation.py
"""
...
STEM = "Tree351_1721039764"
RGB  = f"{PROJ}/data/plantations/rgb_resized/{STEM}.png"
ANN  = (f"{PROJ}/data/combined/annotation_inst/"
        "filtered_rle_f1000_repaired_v4_stratified/instances_test.json")
OUT  = f"{PROJ}/paper/tesis_final/gambar/fig4c_panels_plantation.pdf"
CACHE = f"{PROJ}/reports/fig4c_panels_plantation_cache.pkl"
