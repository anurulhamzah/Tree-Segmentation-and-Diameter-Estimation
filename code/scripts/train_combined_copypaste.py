"""train_combined.py + copy-paste crowd-aug loader.
Patch Trainer.build_train_loader agar memakai CopyPasteDBHDatasetMapper saat
INPUT.COPY_PASTE_PROB>0 (mapper depth/DBH; eval tetap depth-safe pakai mapper test biasa).
Selain itu identik dgn train_combined.
"""
import os
import sys
